...
import ContainerTwoChildContext from './ContainerTwoChildContext.tsx'
...
type ContainerTwoChild = {
    ...
    attributes: any
    secondItems: any
    containerActiveId: any
    secondIndexes: any
    handleSecondStart: any
    handleDragEnd: any
}
const ContainerTwo: React.FC<ContainerTwoChild> = ({ containerIndexes, containerActiveId, handleSecondStart, handleDragEnd, secondItems, secondIndexes }) => {
